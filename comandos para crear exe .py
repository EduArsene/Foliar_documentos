...
#en este apartado se ponen las librerias que tenia instalados en ese entonces, en caso se tenga las mismas librerias
#ponerlo, en caso tener menos o mas puedes editar cualquier linea. Todo esto con el fin de hacer menos la carpeta del ejecutable (.exe)
